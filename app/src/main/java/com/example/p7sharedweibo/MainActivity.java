package com.example.p7sharedweibo;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, WbShareCallback {
    ...
    private static final String APP_KY = "1571445148";
    //在微博开放平台设置的授权回调页
    private static final String REDIRECT_URL = "http://android.com";
    //在微博开放平台为应用申请的高级权限
    ...
    private void doWeiboShare() {
        ...
        mWBAPI.shareMessage(message, mShareClientH5.isChecked());
    }
